...
const ConfirmationChoice = ({
  ...
  return ConfirmationChoice_jsx("div", {
    ...
    className: "card-content"
  }, ConfirmationChoice_jsx("label", null, "Confirmar dados ", ConfirmationChoice_jsx("span", null, " > "), " Confirmar identidade"), ConfirmationChoice_jsx("h2", {
    className: "form-title"
...
const AddressForm = ({
  ...
  return AddressForm_jsx("div", {
    ...
    className: "card-content"
  }, AddressForm_jsx("label", null, "Confirmar dados ", AddressForm_jsx("span", null, " > "), " Endere\xE7o comercial"), AddressForm_jsx(external_formik_["Formik"], {
    initialValues: {
      address: '',
      zipcode: '',
      number: '',
