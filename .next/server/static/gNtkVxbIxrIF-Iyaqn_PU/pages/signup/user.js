...
module.exports = __webpack_require__("rAPA");
...
/* harmony import */ var _components_Register_RegisterSuccess_RegisterSuccess__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("sLzi");
...
const SignupUser = () => {
  ...
  const createUser = async body => {
    try {
      const res = await fetch('https://api.organis8.com.br/api/nao_produtores', {
        method: 'POST',
  ...
  switch (step) {
    ...
    case 3:
      return __jsx(_components_Register_RegisterSuccess_RegisterSuccess__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], null);
  }
};
