...
/* harmony import */ var _utils_mask__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../utils/mask */ "./utils/mask.tsx");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! next/router */ "./node_modules/next/dist/client/router.js");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _utils_validators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/validators */ "./utils/validators.ts");
...
var BePart = function BePart() {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_9__["useState"])(_utils_mask__WEBPACK_IMPORTED_MODULE_12__["Masks"].CPF),
      mask = _useState3[0],
  ...
  var handleChange = function handleChange(e) {
    if (shouldUpdateMask) {
      setMask(_utils_mask__WEBPACK_IMPORTED_MODULE_12__["Masks"].CNPJ);
  ...
  var beforeMaskedValueChange = function beforeMaskedValueChange(values) {
    if (values.selection) {
      ...
      if (mask === _utils_mask__WEBPACK_IMPORTED_MODULE_12__["Masks"].CNPJ && end === 13) {
        setMask(_utils_mask__WEBPACK_IMPORTED_MODULE_12__["Masks"].CPF);
      }
    }
          ...
          case 8:
            ...
            if (data.length) {
              ...
              if (producer) {
                ...
                next_router__WEBPACK_IMPORTED_MODULE_13___default.a.push('/signup/update-producer/[id]', "/signup/update-producer/".concat(producer.id));
              }
            } else {
              setUserNotFound(true);
              next_router__WEBPACK_IMPORTED_MODULE_13___default.a.push("/signup/producer?notFound=true&document=".concat(documentInput));
            }
  ...
  return __jsx("main", {
    ...
    __self: this
  }, "Indique cr\xE9ditos trabalhistas eleg\xEDveis e ganhe conosco, por favor, insira seu CPF ou CNPJ:"), __jsx(_components_Input_Input__WEBPACK_IMPORTED_MODULE_11__["default"], {
    mask: mask,
    ...
    __self: this
  }, "Cadastro n\xE3o encontrado"), documentInput.replace(/\D/g, '').length === 11 && !_utils_validators__WEBPACK_IMPORTED_MODULE_14__["Validators"].cpf(documentInput) && __jsx("span", {
    className: "user-not-found",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 73
    ...
    __self: this
  }, "CPF inv\xE1lido"), documentInput.replace(/\D/g, '').length === 14 && !_utils_validators__WEBPACK_IMPORTED_MODULE_14__["Validators"].cnpj(documentInput) && __jsx("span", {
    className: "user-not-found",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74
...
//# sourceMappingURL=be-part.js.559531508a9c98627774.hot-update.js.map