...
var Index = function Index() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    "class": "button",
    href: "(LINK)",
    style: "float: right; border:1px solid; padding: 11px 21px; vertical-align: middle; background:#2D888F; color:white;border-radius:6px; font-size: 20px; font-family:helvetica, serif;text-decoration:none;",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52
    },
    __self: this
  }, "Abra sua conta")), __jsx("img", {
    src: "/agilidade.svg",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54
...
//# sourceMappingURL=index.js.9fff148c71d142b11957.hot-update.js.map