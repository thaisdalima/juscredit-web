...
var SignupUser = function SignupUser() {
  ...
  var sendConfirmation = function sendConfirmation(choice) {
    var email, phone;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.async(function sendConfirmation$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.awrap(fetch("".concat(process.env.API_URL, "/api/confirmation/send-").concat(choice), {
              method: 'POST',
              body: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_7___default()(confirmationChoice === 'email' ? {
                email: email
              } : {
    ...
    }, null, null, [[1, 6]], _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_8___default.a);
  };

  var handleConfimation = function handleConfimation(value) {
    var email, phone, res;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.async(function handleConfimation$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            _context3.next = 9;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.awrap(createUser(_objectSpread({}, userValues)));
    ...
    }, null, null, [[2, 15]], _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_8___default.a);
  };

  var createUser = function createUser(body) {
    var res, data;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.async(function createUser$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.awrap(fetch("".concat(process.env.API_URL, "/api/nao_produtores"), {
              method: 'POST',
    ...
    }, null, null, [[0, 10]], _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_8___default.a);
  };
...
//# sourceMappingURL=user.js.5dc35967fed801a6844f.hot-update.js.map