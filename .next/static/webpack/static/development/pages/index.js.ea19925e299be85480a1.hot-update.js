...
var Index = function Index(props) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
  ...
  var _React$useState4 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(INITIAL_FORM),
      _React$useState5 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState4, 2),
      formValues = _React$useState5[0],
      setFormValue = _React$useState5[1];

  var _React$useState6 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState({}),
      _React$useState7 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState6, 2),
      parceiroValues = _React$useState7[0],
      setParceiroValue = _React$useState7[1];

  var _React$useState8 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(false),
      _React$useState9 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState8, 2),
      modalIndicarState = _React$useState9[0],
      setIndicarOpen = _React$useState9[1];

  var _React$useState10 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(false),
      _React$useState11 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState10, 2),
      modalAnteciparState = _React$useState11[0],
      setAnteciparOpen = _React$useState11[1];

  var _React$useState12 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(false),
      _React$useState13 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState12, 2),
      modalInvestirState = _React$useState13[0],
      setInvestirOpen = _React$useState13[1];

  var _React$useState14 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(false),
      _React$useState15 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState14, 2),
      modalEnviado = _React$useState15[0],
      setFeedbackEnviado = _React$useState15[1];

  var _React$useState16 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(false),
      _React$useState17 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState16, 2),
      modalErro = _React$useState17[0],
      setFeedbackErro = _React$useState17[1];

  var _React$useState18 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState("cliente"),
      _React$useState19 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState18, 2),
      profile = _React$useState19[0],
      setProfile = _React$useState19[1];

  var _React$useState20 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(''),
      _React$useState21 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState20, 2),
      selectProfile = _React$useState21[0],
      setSelectProfile = _React$useState21[1];

  var _React$useState22 = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(''),
      _React$useState23 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_React$useState22, 2),
      originPath = _React$useState23[0],
      setOriginPath = _React$useState23[1];
...
//# sourceMappingURL=index.js.ea19925e299be85480a1.hot-update.js.map