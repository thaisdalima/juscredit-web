    ...
    <div>
      <div className="contact-card">
        <div className="form-container">
          ...
          <p>É só escrever para <a className="email" href="mailto:thaisdalima@gmail.com">oi@juscredit.com.br</a> ou nos enviar uma mensagem no campo abaixo. Entraremos em contato o mais rápido possível!</p>
          ...
          <a className="link button warn" href={`mailto:thaisdalima@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message + '\n' + name)}`} >Enviar</a>
        </div>
      </div>
    </div>
  );
